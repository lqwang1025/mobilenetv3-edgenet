...
parser.add_argument('--model', '-m', metavar='MODEL', default='tf_mobilenetv3_small_075',
...
parser.add_argument('--checkpoint', default='../models/mnn/tf_mobilenetv3_small_075.pth', 
                    type=str, metavar='PATH',
                    help='path to latest checkpoint (default: none)')
parser.add_argument('--pretrained', dest='pretrained', default=False,
                    help='use pre-trained model',action='store_true')
